...
const Detail = () => {
    ...
    const handleApply = () => {
        ...
        navigate(`/class/${lecture_seq}/${seq}/add`, {
            state: {
                class_seq: seq,
                lecture_seq: lecture_seq,
                        ...
                        <section className="w-80 bg-white p-4">
                            {lectureDoc.plan?.length > 0
                                ? lectureDoc.plan.map((item, index) => (
                                      <div key={index}>
                                          {index == 0 ? <h1 className="fs-2 fw-bold mb-4">강의설명</h1> : null}
                                          <div
                                              className="mb-4"
                            ...
                            {lectureDoc.award?.length > 0
                                ? lectureDoc.award.map((item, index) => (
                                      <div key={index}>
                                          {index == 0 ? <h1 className="fs-2 fw-bold mb-4">수상내역</h1> : null}
                                          <div
                                              className="mb-4"
                                              dangerouslySetInnerHTML={{
                                                  __html: Dompurify.sanitize(String(item || "")),
                            ...
                            {lectureDoc.progress?.length > 0
                                ? lectureDoc.progress.map((item, index) => (
                                      <div key={index}>
                                          {index == 0 ? <h1 className="fs-2 fw-bold mb-4">진행과정</h1> : null}
                                          <div
                                              className="mb-4"
                                              dangerouslySetInnerHTML={{
                                                  __html: Dompurify.sanitize(String(item || "")),
                            ...
                            {lectureDoc.capacity?.length > 0
                                ? lectureDoc.capacity.map((item, index) => (
                                      <div key={index}>
                                          {index == 0 ? <h1 className="fs-2 fw-bold mb-4">필요자격</h1> : null}
                                          <div
                                              className="mb-4"
                                              dangerouslySetInnerHTML={{
                                                  __html: Dompurify.sanitize(String(item || "")),
                            ...
                            {lectureDoc.procedure?.length > 0
                                ? lectureDoc.procedure.map((item, index) => (
                                      <div key={index}>
                                          {index == 0 ? <h1 className="fs-2 fw-bold mb-4">취업과정</h1> : null}
                                          <div
                                              className="mb-4"
                                              dangerouslySetInnerHTML={{
                                                  __html: Dompurify.sanitize(String(item || "")),
